...
// for the decode, an awaited stage — are the renderers', not the library's.
//
...
// ---------------------------------------------------------------- HUD
// One readout, and the argument is what the toggle does to it: the
// texture's width changes unit — vertices to slots — and its memory drops by
// two orders of magnitude. Both bake times stay on screen, because the second
// one was the wait at load.
//
