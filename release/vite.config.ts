...
// The dev server behind `pnpm parity`. It exists only so the gate's page can be
// opened in a real browser (parity/check.mjs); nothing here is ever built or
// deployed — the gate is a release step, not a page a stranger visits.
//
