...
`three-vat` ships as one package with subpath exports: `three-vat` (core baker + instance-playback contract), `three-vat/webgl` (GLSL patch), `three-vat/tsl` (node material).
