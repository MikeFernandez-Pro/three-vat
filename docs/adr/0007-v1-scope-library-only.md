...
> **Amended by [ADR-0010](./0010-drop-the-offline-format-runtime-bake-is-the-library.md):**
> three surfaces, not four. The offline format is cut; the runtime bake is the only
> way to produce a VAT. The CLI, drei hook and crossfade stay deferred as below —
